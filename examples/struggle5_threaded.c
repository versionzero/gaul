/**********************************************************************
  struggle5_threaded.c
 **********************************************************************

  struggle5_threaded - Test/example program for GAUL.
 ...
 **********************************************************************
  ...
  Synopsis:	Test/example program for GAUL.
		...
		multi-threaded version of the algorithm.
...
int main(int argc, char **argv)
  ...
  ga_evolution_archipelago_threaded( GA_STRUGGLE_NUM_POPS, pop, 250 );

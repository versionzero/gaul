 ...
 **********************************************************************
  ...
  polynomial_sd - Demonstration program for GAUL.
 ...
 **********************************************************************
  ...
  Last Updated:	25 Nov 2002 SAA	Based on examples/polynomial_simplex.c
...
boolean polynomial_from_double(population *pop, entity *entity, double *array)
  {
...
/**********************************************************************
  polynomial_analytical_gradient()
...
double polynomial_analytical_gradient(population *pop, entity *entity, double *params, double *grad)
  {
...
boolean polynomial_iteration_callback(int iteration, entity *solution)
  {
...
int main(int argc, char **argv)
  ...
  ga_population_set_gradient_parameters(
       ...
       polynomial_analytical_gradient,	/* const GAgradient	gradient */

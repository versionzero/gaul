 ...
 **********************************************************************
  ...
  Synopsis:	Test/example program for GAUL using the
		ga_evolution_forked() evolution function.  Please
		note that the overhead of the 'fork()'s completely
		eliminates any benefit for such a simple evaluation
		function.  The main purpose of this example is to
		prove that the results of ga_evolution() and
		ga_evolution_forked() are identical.
